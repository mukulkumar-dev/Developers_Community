...
export default function Features() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-r from-gray-500 to-blue-600 text-white flex flex-col items-center p-8">
      <motion.div
      ...
      >
        ...
        <div className="mt-20 flex items-center justify-center">
          <input
            ...
            className="w-2/3 p-3 bg-gray-200 text-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-800"
          />
          <button
            onClick={() => console.log("Search Query:", search)} // Just for debugging
            className="ml-4 bg-blue-500 px-6 py-3 rounded-lg font-bold"
          >
            Search
          </button>
        </div>
        ...
        <div className="mt-8 space-y-6 ">
          {filteredRequests.length > 0 ? (
            filteredRequests.map((request, index) => (
              <motion.div
                key={index}
                className="p-6  bg-opacity-40 rounded-xl shadow-lg bg-white/10 backdrop-blur-lg md:flex-row w-full "
              ...
              >
                ...
                <div className="flex items-center gap-4 mt-2">
                  ...
                  <span className="text-blue-500">{request.comments} Comments</span>
